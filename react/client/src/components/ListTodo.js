...
const ListTodo = () => {
  ...
  // Color class based on index (for border accent when no tag yet)
    ...
    <Fragment>
      ...
      <div className="stats-row">
        ...
        <div className="stat-card stat-done">
          ...
          <div className="stat-label">TAMAM ✓</div>
        </div>
        <div className="stat-card stat-open">
          <div className="stat-num">{openCount}</div>
          <div className="stat-label">BEKLİYOR</div>
        </div>
      </div>
      ...
      <div className="list-wrap">
        {todos.length === 0 ? (
          <div className="list-empty">
            ...
            <p>Henüz görev yok. Yukarıdan ekleyin!</p>
          </div>
        ) : (
          todos.map((todo, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Tag badge + Edit modal (EditTodo renders both) */}
                <EditTodo todo={todo} />
