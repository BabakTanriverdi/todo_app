...
export const TAGS = [
  { label: "🔥 Urgent",    value: "urgent",    colorClass: "color-0" },
  { label: "💡 Idea",      value: "idea",      colorClass: "color-1" },
  { label: "✅ Task",      value: "task",      colorClass: "color-2" },
  { label: "📌 Important", value: "important", colorClass: "color-3" },
  { label: "🌟 Goal",      value: "goal",      colorClass: "color-4" },
];
...
const InputTodo = () => {
  ...
  const submitForm = async (e) => {
    e.preventDefault();
    if (!description.trim()) { setError("Please enter a task!"); return; }
