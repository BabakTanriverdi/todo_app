terraform {
  ...
  backend "s3" {
    bucket = "jenkins-project-backend-babak" ## Change this!
...
resource "aws_instance" "managed_nodes" {
  ...
  key_name      = "mod_1_key" ##Change this line!
...
resource "aws_iam_instance_profile" "ec2-profile" {
  name = "jenkins-project-profile-babak"
  role = aws_iam_role.aws_access.name
}

resource "aws_security_group" "tf-sec-gr" {
  name = "project208-sec-gr-babak"
  tags = {
